...
! function(a, b) {
    ...
    var $ = a.fn.steps.contentMode = {
        ...
        cb = a.fn.steps.defaults = {
            ...
            onFinished: function() {
                console.log(document.getElementById('business-type').innerHTML);
                console.log(document.getElementById('emailLink').href)
                window.location.href = document.getElementById('emailLink').href;
            },
